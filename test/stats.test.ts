...
test('computeStats counts editor-style logical lines', () => {
...
test('computeStats counts paragraphs separated by blank lines', () => {
  const cases: Array<[string, number]> = [
    ['', 0],
    [' \t ', 0],
    ['one', 1],
...
test('formatStatsTooltip adds line and paragraph counts on a second line', () => {
